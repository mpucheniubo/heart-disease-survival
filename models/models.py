...
class XGBSEKaplanNeighborsModel(Model):
    """
    This implements the interface for the XGBoost Survival Embeddings model Kaplan Neighbors. On top of the ABC attributes it has:
    ...
    def train(self) -> None:
        """
        This serves as a wrapper to fit the model and populate the feature importance.
        """
        logging.info("Fitting mdoel.")
        self._model.fit(self.x_train, self.y_train, time_bins=self.time_bins)
